...
export class PorukeRazmenjeneComponent implements OnInit {
  ...
  constructor(private router: Router, private authService: AuthenticationService, private zahtevService: PorukaService,
    private snackBar: MatSnackBar, private dialog: MatDialog) { }

    ngOnInit() {
      this.zahtevService.getZahteviPoruke().subscribe(
        data => {
          console.log(data);
          this.zahtevi = data;
